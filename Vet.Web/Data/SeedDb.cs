...
namespace Vet.Web.Data
{
    public class SeedDb
    {
        ...
        public async Task SeedAsync()
        {
            ...
            await CheckRoles();
            var manager = await CheckUserAsync("1010", "Carlos", "Araújo", "calaraujo@hotmail.com", "31 971428999", "Calle Luna Calle Sol", "Admin");
            var customer = await CheckUserAsync("2020", "Carlos", "Araújo", "calaraujo@msn.com", "31 25640223", "Calle Luna Calle Sol", "Customer");
        ...
        private async Task CheckServiceTypesAsync()
        {
            if (!_dataContext.ServiceTypes.Any())
            {
                ...
                _dataContext.ServiceTypes.Add(new ServiceType { Name = "Vacinação" });
                await _dataContext.SaveChangesAsync();
            }
        }
